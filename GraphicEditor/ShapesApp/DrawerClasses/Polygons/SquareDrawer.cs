...
namespace ShapesApp.DrawerClasses.Polygons
{
    public class SquareDrawer : Drawer
    {
        ...
        public override void draw()
        {
            ...
            Gl.glVertex2d(shape.Coords[0].x + shape.Height, shape.Coords[0].y + shape.Height);
            Gl.glVertex2d(shape.Coords[0].x + shape.Height, shape.Coords[0].y);
            Gl.glEnd();
            Gl.glFlush();
        }
        ...
        {
            {
                ...
                shape.SetCoords(coordBottomLeft, Math.Abs(coords[1].x - coords[0].x));
            }
        }
        public SquareDrawer()
        {
